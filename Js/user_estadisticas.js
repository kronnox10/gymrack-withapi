function grafica_Asistencia_consulta() {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas_user_asistencia',
        data: {
            id:ide
        }
...
function grafica_Progreso_peso() {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas_De_Pogreso_peso',
        data: {
            id:ide
        }
    }).then(function (response) {
