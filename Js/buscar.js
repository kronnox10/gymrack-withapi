...
function lista() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/getlista',
...
function editar(id) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/datosuser',
        data: {
            id: id
        }
    }).then(function (response) {
...
function actualizarLosDatos() {
    ...
    axios({
        ...
        method: 'PUT',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py//update/<id>',
        data: {
            name: vnombre,
...
function Buscar() {
    ...
    axios({
        ...
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/Buscarusuario'
    }).then(function (response) {
...
function eliminar(id) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/deleteUser',
        data: {
            id: vid
        }
...
function listaEntrenador() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/getlistaEntrenador',
...
function solicitud(iden) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/solicitud',
        data: {
            id_usuario: ide,
...
function lista_de_entrenador() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/getlistaEntrenador',//aca, dale ahora a ver
...
function editar_entrenador(id) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/datosEntrenador',
        data: {
            id: id
        }
    }).then(function (response) {
...
function actualizarLosDatos_entrenador() {
    ...
    *///-----------
    ...
    axios({
        ...
        method: 'PUT',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/update/entrenador',
        data: {
            name: vnombre,
            direccion: vdireccion,
            correo: vcorreo,
...
function BuscarEntrenador() {
    ...
    axios({
        ...
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/Buscarentrenador',
...
function eliminar_entrenador(id) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/deleteEntrenador',
        data: {
            id: vid
        }
...
function entrenador_aceptado() {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/entrenadores_QueTe_Aceptaron',
        data: {
            id_usuario: ide,
        }
...
function enviarCalificacion() {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/buscarvaloracion',
        data: {
...
function enviar(i) {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/valoracionEntrenador',
        data: {
            id_usuario: ide,
            id_entrenador: xidentrenador,
            x: x,
