function grafica_Asistencia_consulta() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas'
...
function estadisticas2() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas/genero'
    }).then(function (response) {
        const dataHombre = [];
...
function estadisticas_por_mes() {
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas_por_mes'
    }).then(function (response) {
...
function estadisticas_planes() {
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas_De_Planes'//
    }).then(function (response) {
...
function pdf_estadisticas_Entrenador_y_sus_Usuarios() {
    ...
    axios({
        method: 'GET',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/estadisticas_Entrenador_y_sus_Usuarios',
        //
    }).then(function (response) {
        var body = [];
        //
