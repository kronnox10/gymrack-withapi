function grafica_Asistencia_consulta() {
    ...
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:6122/estadisticas'
...
function estadisticas2() {
    ...
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:6122/estadisticas/genero'
    }).then(function (response) {
        const dataHombre = [];
...
function estadisticas_por_mes() {
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:6122/estadisticas_por_mes'
    }).then(function (response) {
...
function estadisticas_planes() {
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:6122/estadisticas_De_Planes'//
    }).then(function (response) {
...
function pdf_estadisticas_Entrenador_y_sus_Usuarios() {
    ...
    axios({
        method: 'GET',
        url: 'http://127.0.0.1:6122/estadisticas_Entrenador_y_sus_Usuarios',
        //
    }).then(function (response) {
        var body = [];
        //
