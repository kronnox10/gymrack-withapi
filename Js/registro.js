...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formulario.addEventListener("submit", async (e) => {
        ...
        if (seguridad == vcontraseña) {
            axios({
                method: 'POST',
                url: 'http://127.0.0.1:3550/add_usuario',
                data: {
                    name: vnombres,
...
function revisar_solicitudes() {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3550/revisarSolicitudes',
        data: {
            id_entrenador: ide
        }
...
function rechazar_solicitud(id) {
    ...
    axios({
        method: 'DELETE',
        url: 'http://127.0.0.1:3550/AceptarSolicitudes',
        data: {
            id_entrenador: ide,
            id_usuario: id,
...
function usuarios_aceptados() {
    ...
    axios({
        method: 'POST',
        url: 'http://127.0.0.1:3550/usuarios_aceptados',
        data: {
            id_entrenador: ide,
        }
