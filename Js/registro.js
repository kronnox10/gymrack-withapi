...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formulario.addEventListener("submit", async (e) => {
        ...
        if (seguridad == vcontraseña) {
            axios({
                method: 'POST',
                url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/add_usuario',
                data: {
                    name: vnombres,
...
function revisar_solicitudes() {
    ...
    axios({
        method: 'POST',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/revisarSolicitudes',
        data: {
            id_entrenador: ide
        }
...
function rechazar_solicitud(id) {
    ...
    axios({
        method: 'DELETE',
        url: 'https://www.pythonanywhere.com/user/kronnox/files/home/kronnox/App.py/AceptarSolicitudes',
        data: {
            id_entrenador: ide,
            id_usuario: id,
